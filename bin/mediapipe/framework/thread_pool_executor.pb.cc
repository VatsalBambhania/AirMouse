...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ThreadPoolExecutorOptions_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto;
namespace mediapipe {
class ThreadPoolExecutorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ThreadPoolExecutorOptions> _instance;
} _ThreadPoolExecutorOptions_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_ThreadPoolExecutorOptions_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_ThreadPoolExecutorOptions_default_instance_;
    new (ptr) ::mediapipe::ThreadPoolExecutorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::ThreadPoolExecutorOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ThreadPoolExecutorOptions_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ThreadPoolExecutorOptions_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, sizeof(::mediapipe::ThreadPoolExecutorOptions)},
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto_sccs[1] = {
  &scc_info_ThreadPoolExecutorOptions_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto = {
  &descriptor_table_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto_initialized, descriptor_table_protodef_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto, "mediapipe/framework/thread_pool_executor.proto", 468,
  &descriptor_table_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto_once, descriptor_table_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto_sccs, descriptor_table_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto::offsets,
  file_level_metadata_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto, 1, file_level_enum_descriptors_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto, file_level_service_descriptors_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto), true);
namespace mediapipe {
...
void ThreadPoolExecutorOptions::InitAsDefaultInstance() {
}
...
ThreadPoolExecutorOptions::ThreadPoolExecutorOptions()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.ThreadPoolExecutorOptions)
}
ThreadPoolExecutorOptions::ThreadPoolExecutorOptions(const ThreadPoolExecutorOptions& from)
  ...
  if (from._internal_has_thread_name_prefix()) {
    thread_name_prefix_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.thread_name_prefix_);
  }
...
void ThreadPoolExecutorOptions::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ThreadPoolExecutorOptions_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto.base);
  thread_name_prefix_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void ThreadPoolExecutorOptions::SharedDtor() {
...
const ThreadPoolExecutorOptions& ThreadPoolExecutorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ThreadPoolExecutorOptions_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto.base);
...
// @@protoc_insertion_point(message_clear_start:mediapipe.ThreadPoolExecutorOptions)
  ...
  if (cached_has_bits & 0x00000001u) {
    thread_name_prefix_.ClearNonDefaultToEmptyNoArena();
  }
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          stack_size_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          nice_priority_level_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* ThreadPoolExecutorOptions::_InternalSerialize(
...
// @@protoc_insertion_point(message_byte_size_start:mediapipe.ThreadPoolExecutorOptions)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(
          this->_internal_nice_priority_level());
    }
...
void ThreadPoolExecutorOptions::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:mediapipe.ThreadPoolExecutorOptions)
  GOOGLE_DCHECK_NE(&from, this);
  const ThreadPoolExecutorOptions* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ThreadPoolExecutorOptions>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mediapipe.ThreadPoolExecutorOptions)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mediapipe.ThreadPoolExecutorOptions)
    MergeFrom(*source);
  }
}
...
void ThreadPoolExecutorOptions::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:mediapipe.ThreadPoolExecutorOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ThreadPoolExecutorOptions::InternalSwap(ThreadPoolExecutorOptions* other) {
  ...
  thread_name_prefix_.Swap(&other->thread_name_prefix_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  swap(num_threads_, other->num_threads_);
  swap(stack_size_, other->stack_size_);
  swap(nice_priority_level_, other->nice_priority_level_);
  swap(require_processor_performance_, other->require_processor_performance_);
}
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::MediaPipeOptions,
  ...
  ThreadPoolExecutorOptions::ext(kExtFieldNumber, *::mediapipe::ThreadPoolExecutorOptions::internal_default_instance());
...
template<> PROTOBUF_NOINLINE ::mediapipe::ThreadPoolExecutorOptions* Arena::CreateMaybeMessage< ::mediapipe::ThreadPoolExecutorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::ThreadPoolExecutorOptions >(arena);
}
