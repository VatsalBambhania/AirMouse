...
namespace mediapipe {
class StatusHandlerConfigDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<StatusHandlerConfig> _instance;
} _StatusHandlerConfig_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_StatusHandlerConfig_mediapipe_2fframework_2fstatus_5fhandler_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_StatusHandlerConfig_default_instance_;
    new (ptr) ::mediapipe::StatusHandlerConfig();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::StatusHandlerConfig::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_StatusHandlerConfig_mediapipe_2fframework_2fstatus_5fhandler_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_StatusHandlerConfig_mediapipe_2fframework_2fstatus_5fhandler_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediapipe_2fframework_2fstatus_5fhandler_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, sizeof(::mediapipe::StatusHandlerConfig)},
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto_sccs[1] = {
...
static bool descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto = {
  &descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto_initialized, descriptor_table_protodef_mediapipe_2fframework_2fstatus_5fhandler_2eproto, "mediapipe/framework/status_handler.proto", 244,
  &descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto_once, descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto_sccs, descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_mediapipe_2fframework_2fstatus_5fhandler_2eproto::offsets,
  file_level_metadata_mediapipe_2fframework_2fstatus_5fhandler_2eproto, 1, file_level_enum_descriptors_mediapipe_2fframework_2fstatus_5fhandler_2eproto, file_level_service_descriptors_mediapipe_2fframework_2fstatus_5fhandler_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fframework_2fstatus_5fhandler_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto), true);
namespace mediapipe {

// ===================================================================

void StatusHandlerConfig::InitAsDefaultInstance() {
  ::mediapipe::_StatusHandlerConfig_default_instance_._instance.get_mutable()->options_ = const_cast< ::mediapipe::MediaPipeOptions*>(
...
StatusHandlerConfig::StatusHandlerConfig()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.StatusHandlerConfig)
}
StatusHandlerConfig::StatusHandlerConfig(const StatusHandlerConfig& from)
  ...
  if (from._internal_has_status_handler()) {
    status_handler_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.status_handler_);
  }
...
void StatusHandlerConfig::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_StatusHandlerConfig_mediapipe_2fframework_2fstatus_5fhandler_2eproto.base);
  status_handler_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  options_ = nullptr;
}
...
void StatusHandlerConfig::SharedDtor() {
...
const StatusHandlerConfig& StatusHandlerConfig::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_StatusHandlerConfig_mediapipe_2fframework_2fstatus_5fhandler_2eproto.base);
...
// @@protoc_insertion_point(message_clear_start:mediapipe.StatusHandlerConfig)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      status_handler_.ClearNonDefaultToEmptyNoArena();
    }
...
::PROTOBUF_NAMESPACE_ID::uint8* StatusHandlerConfig::_InternalSerialize(
...
void StatusHandlerConfig::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:mediapipe.StatusHandlerConfig)
  GOOGLE_DCHECK_NE(&from, this);
  const StatusHandlerConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<StatusHandlerConfig>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mediapipe.StatusHandlerConfig)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mediapipe.StatusHandlerConfig)
    MergeFrom(*source);
  }
}
...
void StatusHandlerConfig::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:mediapipe.StatusHandlerConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void StatusHandlerConfig::InternalSwap(StatusHandlerConfig* other) {
  ...
  status_handler_.Swap(&other->status_handler_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
template<> PROTOBUF_NOINLINE ::mediapipe::StatusHandlerConfig* Arena::CreateMaybeMessage< ::mediapipe::StatusHandlerConfig >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::StatusHandlerConfig >(arena);
}
