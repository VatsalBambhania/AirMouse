...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Range_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_SplitVectorCalculatorOptions_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto;
namespace mediapipe {
class RangeDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Range> _instance;
} _Range_default_instance_;
class SplitVectorCalculatorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<SplitVectorCalculatorOptions> _instance;
} _SplitVectorCalculatorOptions_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_Range_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_Range_default_instance_;
    new (ptr) ::mediapipe::Range();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::Range::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Range_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Range_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto}, {}};

static void InitDefaultsscc_info_SplitVectorCalculatorOptions_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_SplitVectorCalculatorOptions_default_instance_;
    new (ptr) ::mediapipe::SplitVectorCalculatorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::SplitVectorCalculatorOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_SplitVectorCalculatorOptions_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_SplitVectorCalculatorOptions_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto}, {
      &scc_info_Range_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto.base,}};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto_sccs[2] = {
  &scc_info_Range_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto.base,
  &scc_info_SplitVectorCalculatorOptions_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto = {
  &descriptor_table_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto_initialized, descriptor_table_protodef_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto, "mediapipe/calculators/core/split_vector_calculator.proto", 359,
  &descriptor_table_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto_sccs, descriptor_table_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto_deps, 2, 1,
  schemas, file_default_instances, TableStruct_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto::offsets,
  file_level_metadata_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto, 2, file_level_enum_descriptors_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto), true);
namespace mediapipe {
...
Range::Range()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.Range)
}
...
const Range& Range::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Range_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto.base);
...
void SplitVectorCalculatorOptions::InitAsDefaultInstance() {
}
...
SplitVectorCalculatorOptions::SplitVectorCalculatorOptions()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.SplitVectorCalculatorOptions)
}
...
void SplitVectorCalculatorOptions::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_SplitVectorCalculatorOptions_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto.base);
...
const SplitVectorCalculatorOptions& SplitVectorCalculatorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SplitVectorCalculatorOptions_mediapipe_2fcalculators_2fcore_2fsplit_5fvector_5fcalculator_2eproto.base);
  return *internal_default_instance();
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          element_only_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          combine_outputs_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void SplitVectorCalculatorOptions::InternalSwap(SplitVectorCalculatorOptions* other) {
  ...
  swap(element_only_, other->element_only_);
  swap(combine_outputs_, other->combine_outputs_);
}
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  SplitVectorCalculatorOptions::ext(kExtFieldNumber, *::mediapipe::SplitVectorCalculatorOptions::internal_default_instance());

// @@protoc_insertion_point(namespace_scope)
}  // namespace mediapipe
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::mediapipe::Range* Arena::CreateMaybeMessage< ::mediapipe::Range >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::Range >(arena);
}
template<> PROTOBUF_NOINLINE ::mediapipe::SplitVectorCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::SplitVectorCalculatorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::SplitVectorCalculatorOptions >(arena);
}
