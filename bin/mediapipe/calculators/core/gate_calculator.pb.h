...
class GateCalculatorOptions :
 ...
 public:
  ...
  inline GateCalculatorOptions* New() const final {
    return CreateMaybeMessage<GateCalculatorOptions>(nullptr);
  }

  GateCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_mediapipe_2fcalculators_2fcore_2fgate_5fcalculator_2eproto);
    return ::descriptor_table_mediapipe_2fcalculators_2fcore_2fgate_5fcalculator_2eproto.file_level_metadata[kIndexInFileMessages];
  }
