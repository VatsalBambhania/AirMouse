...
inline bool ImageCroppingCalculatorOptions_BorderMode_Parse(
    const std::string& name, ImageCroppingCalculatorOptions_BorderMode* value) {
...
class ImageCroppingCalculatorOptions :
 ...
 public:
  ...
  virtual ~ImageCroppingCalculatorOptions();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_mediapipe_2fcalculators_2fimage_2fimage_5fcropping_5fcalculator_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  static inline bool BorderMode_Parse(const std::string& name,
      BorderMode* value) {
