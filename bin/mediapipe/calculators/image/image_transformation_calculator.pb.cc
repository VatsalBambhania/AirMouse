...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ImageTransformationCalculatorOptions_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto;
namespace mediapipe {
class RotationModeDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<RotationMode> _instance;
} _RotationMode_default_instance_;
class ImageTransformationCalculatorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ImageTransformationCalculatorOptions> _instance;
} _ImageTransformationCalculatorOptions_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_ImageTransformationCalculatorOptions_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_ImageTransformationCalculatorOptions_default_instance_;
    new (ptr) ::mediapipe::ImageTransformationCalculatorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::ImageTransformationCalculatorOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ImageTransformationCalculatorOptions_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ImageTransformationCalculatorOptions_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto}, {}};

static void InitDefaultsscc_info_RotationMode_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_RotationMode_default_instance_;
    new (ptr) ::mediapipe::RotationMode();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::RotationMode::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RotationMode_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_RotationMode_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::mediapipe::RotationMode, _has_bits_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 5, sizeof(::mediapipe::RotationMode)},
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto_sccs[2] = {
  &scc_info_ImageTransformationCalculatorOptions_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto.base,
  &scc_info_RotationMode_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto = {
  &descriptor_table_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto_initialized, descriptor_table_protodef_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto, "mediapipe/calculators/image/image_transformation_calculator.proto", 639,
  &descriptor_table_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto_sccs, descriptor_table_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto_deps, 2, 2,
  ...
  file_level_metadata_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto, 2, file_level_enum_descriptors_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto), true);
namespace mediapipe {
...
void RotationMode::InitAsDefaultInstance() {
}
class RotationMode::_Internal {
 public:
  using HasBits = decltype(std::declval<RotationMode>()._has_bits_);
};

RotationMode::RotationMode()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.RotationMode)
}
...
const RotationMode& RotationMode::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_RotationMode_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto.base);
...
void ImageTransformationCalculatorOptions::InitAsDefaultInstance() {
}
...
ImageTransformationCalculatorOptions::ImageTransformationCalculatorOptions()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.ImageTransformationCalculatorOptions)
}
...
const ImageTransformationCalculatorOptions& ImageTransformationCalculatorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ImageTransformationCalculatorOptions_mediapipe_2fcalculators_2fimage_2fimage_5ftransformation_5fcalculator_2eproto.base);
  return *internal_default_instance();
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          output_width_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          output_height_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 56)) {
          ...
          constant_padding_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void ImageTransformationCalculatorOptions::InternalSwap(ImageTransformationCalculatorOptions* other) {
  ...
  swap(scale_mode_, other->scale_mode_);
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  ImageTransformationCalculatorOptions::ext(kExtFieldNumber, *::mediapipe::ImageTransformationCalculatorOptions::internal_default_instance());

// @@protoc_insertion_point(namespace_scope)
}  // namespace mediapipe
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::mediapipe::RotationMode* Arena::CreateMaybeMessage< ::mediapipe::RotationMode >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::RotationMode >(arena);
}
template<> PROTOBUF_NOINLINE ::mediapipe::ImageTransformationCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::ImageTransformationCalculatorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::ImageTransformationCalculatorOptions >(arena);
}
