...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TfLiteTensorsToDetectionsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto;
namespace mediapipe {
class TfLiteTensorsToDetectionsCalculatorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<TfLiteTensorsToDetectionsCalculatorOptions> _instance;
} _TfLiteTensorsToDetectionsCalculatorOptions_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_TfLiteTensorsToDetectionsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_TfLiteTensorsToDetectionsCalculatorOptions_default_instance_;
    new (ptr) ::mediapipe::TfLiteTensorsToDetectionsCalculatorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::TfLiteTensorsToDetectionsCalculatorOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TfLiteTensorsToDetectionsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_TfLiteTensorsToDetectionsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto}, {}};
...
const char descriptor_table_protodef_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "latorOptions\022\023\n\013num_classes\030\001 \002(\005\022\021\n\tnum"
  "_boxes\030\002 \002(\005\022\022\n\nnum_coords\030\003 \002(\005\022\035\n\025keyp"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto_sccs[1] = {
  &scc_info_TfLiteTensorsToDetectionsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto = {
  &descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto_initialized, descriptor_table_protodef_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto, "mediapipe/calculators/tflite/tflite_tensors_to_detections_calculator.proto", 761,
  &descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto_sccs, descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto_deps, 1, 1,
  ...
  file_level_metadata_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto, 1, file_level_enum_descriptors_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto), true);
namespace mediapipe {

// ===================================================================

void TfLiteTensorsToDetectionsCalculatorOptions::InitAsDefaultInstance() {
}
...
TfLiteTensorsToDetectionsCalculatorOptions::TfLiteTensorsToDetectionsCalculatorOptions()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.TfLiteTensorsToDetectionsCalculatorOptions)
}
...
const TfLiteTensorsToDetectionsCalculatorOptions& TfLiteTensorsToDetectionsCalculatorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_TfLiteTensorsToDetectionsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5ftensors_5fto_5fdetections_5fcalculator_2eproto.base);
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          num_boxes_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          num_coords_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 64)) {
          ...
          do {
            ptr += 1;
            _internal_add_ignore_classes(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr));
            CHK_(ptr);
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 72)) {
          ...
          keypoint_coord_offset_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 88)) {
          ...
          num_values_per_keypoint_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 96)) {
          ...
          box_coord_offset_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 104)) {
          ...
          apply_exponential_on_box_size_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 112)) {
          ...
          reverse_output_order_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 120)) {
          ...
          sigmoid_score_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
size_t TfLiteTensorsToDetectionsCalculatorOptions::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:mediapipe.TfLiteTensorsToDetectionsCalculatorOptions)
  size_t total_size = 0;

  if (_internal_has_num_classes()) {
    // required int32 num_classes = 1;
    total_size += 1 +
...
void TfLiteTensorsToDetectionsCalculatorOptions::InternalSwap(TfLiteTensorsToDetectionsCalculatorOptions* other) {
  ...
  swap(num_boxes_, other->num_boxes_);
  swap(num_coords_, other->num_coords_);
  swap(x_scale_, other->x_scale_);
  swap(y_scale_, other->y_scale_);
  swap(w_scale_, other->w_scale_);
  swap(h_scale_, other->h_scale_);
  swap(keypoint_coord_offset_, other->keypoint_coord_offset_);
  swap(num_keypoints_, other->num_keypoints_);
  swap(box_coord_offset_, other->box_coord_offset_);
  swap(apply_exponential_on_box_size_, other->apply_exponential_on_box_size_);
  swap(reverse_output_order_, other->reverse_output_order_);
  swap(sigmoid_score_, other->sigmoid_score_);
  swap(flip_vertically_, other->flip_vertically_);
  swap(score_clipping_thresh_, other->score_clipping_thresh_);
  swap(min_score_thresh_, other->min_score_thresh_);
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  TfLiteTensorsToDetectionsCalculatorOptions::ext(kExtFieldNumber, *::mediapipe::TfLiteTensorsToDetectionsCalculatorOptions::internal_default_instance());
...
template<> PROTOBUF_NOINLINE ::mediapipe::TfLiteTensorsToDetectionsCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::TfLiteTensorsToDetectionsCalculatorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::TfLiteTensorsToDetectionsCalculatorOptions >(arena);
}
