...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SsdAnchorsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto;
namespace mediapipe {
class SsdAnchorsCalculatorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<SsdAnchorsCalculatorOptions> _instance;
...
static void InitDefaultsscc_info_SsdAnchorsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto() {
  ...
  {
    void* ptr = &::mediapipe::_SsdAnchorsCalculatorOptions_default_instance_;
    new (ptr) ::mediapipe::SsdAnchorsCalculatorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::SsdAnchorsCalculatorOptions::InitAsDefaultInstance();
}
...
const char descriptor_table_protodef_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "_scale\030\003 \002(\002\022\021\n\tmax_scale\030\004 \002(\002\022\034\n\017ancho"
  "r_offset_x\030\005 \002(\002:\0030.5\022\034\n\017anchor_offset_y"
  "\030\006 \002(\002:\0030.5\022\022\n\nnum_layers\030\007 \002(\005\022\031\n\021featu"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto_sccs[1] = {
  &scc_info_SsdAnchorsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto = {
  &descriptor_table_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto_initialized, descriptor_table_protodef_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto, "mediapipe/calculators/tflite/ssd_anchors_calculator.proto", 615,
  &descriptor_table_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto_sccs, descriptor_table_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto::offsets,
  file_level_metadata_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto, 1, file_level_enum_descriptors_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto), true);
namespace mediapipe {

// ===================================================================

void SsdAnchorsCalculatorOptions::InitAsDefaultInstance() {
}
...
SsdAnchorsCalculatorOptions::SsdAnchorsCalculatorOptions()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.SsdAnchorsCalculatorOptions)
}
...
const SsdAnchorsCalculatorOptions& SsdAnchorsCalculatorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SsdAnchorsCalculatorOptions_mediapipe_2fcalculators_2ftflite_2fssd_5fanchors_5fcalculator_2eproto.base);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          input_size_width_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          input_size_height_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 64)) {
          ...
          do {
            ptr += 1;
            _internal_add_feature_map_width(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr));
            CHK_(ptr);
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 72)) {
          ...
          do {
            ptr += 1;
            _internal_add_feature_map_height(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr));
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 112)) {
          ...
          fixed_anchor_size_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
size_t SsdAnchorsCalculatorOptions::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:mediapipe.SsdAnchorsCalculatorOptions)
  size_t total_size = 0;

  if (_internal_has_input_size_width()) {
    // required int32 input_size_width = 1;
    total_size += 1 +
  ...
  if (_internal_has_input_size_height()) {
    // required int32 input_size_height = 2;
    total_size += 1 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(
  ...
  if (_internal_has_min_scale()) {
    // required float min_scale = 3;
    total_size += 1 + 4;
  }

  if (_internal_has_max_scale()) {
    // required float max_scale = 4;
    total_size += 1 + 4;
  }
  ...
  if (_internal_has_anchor_offset_x()) {
    // required float anchor_offset_x = 5 [default = 0.5];
    total_size += 1 + 4;
  }

  if (_internal_has_anchor_offset_y()) {
    // required float anchor_offset_y = 6 [default = 0.5];
    total_size += 1 + 4;
  }
...
void SsdAnchorsCalculatorOptions::InternalSwap(SsdAnchorsCalculatorOptions* other) {
  ...
  swap(input_size_width_, other->input_size_width_);
  swap(input_size_height_, other->input_size_height_);
  ...
  swap(fixed_anchor_size_, other->fixed_anchor_size_);
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  SsdAnchorsCalculatorOptions::ext(kExtFieldNumber, *::mediapipe::SsdAnchorsCalculatorOptions::internal_default_instance());
...
template<> PROTOBUF_NOINLINE ::mediapipe::SsdAnchorsCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::SsdAnchorsCalculatorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::SsdAnchorsCalculatorOptions >(arena);
}
