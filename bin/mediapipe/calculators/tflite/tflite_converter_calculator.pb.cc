...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_TfLiteConverterCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TfLiteConverterCalculatorOptions_TensorFloatRange_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto;
namespace mediapipe {
class TfLiteConverterCalculatorOptions_TensorFloatRangeDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<TfLiteConverterCalculatorOptions_TensorFloatRange> _instance;
} _TfLiteConverterCalculatorOptions_TensorFloatRange_default_instance_;
class TfLiteConverterCalculatorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<TfLiteConverterCalculatorOptions> _instance;
} _TfLiteConverterCalculatorOptions_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_TfLiteConverterCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_TfLiteConverterCalculatorOptions_default_instance_;
    new (ptr) ::mediapipe::TfLiteConverterCalculatorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::TfLiteConverterCalculatorOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_TfLiteConverterCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_TfLiteConverterCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto}, {
      &scc_info_TfLiteConverterCalculatorOptions_TensorFloatRange_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto.base,}};

static void InitDefaultsscc_info_TfLiteConverterCalculatorOptions_TensorFloatRange_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_TfLiteConverterCalculatorOptions_TensorFloatRange_default_instance_;
    new (ptr) ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TfLiteConverterCalculatorOptions_TensorFloatRange_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_TfLiteConverterCalculatorOptions_TensorFloatRange_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto_sccs[2] = {
  &scc_info_TfLiteConverterCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto.base,
  &scc_info_TfLiteConverterCalculatorOptions_TensorFloatRange_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto = {
  &descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto_initialized, descriptor_table_protodef_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto, "mediapipe/calculators/tflite/tflite_converter_calculator.proto", 632,
  &descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto_sccs, descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto_deps, 2, 1,
  ...
  file_level_metadata_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto, 2, file_level_enum_descriptors_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto), true);
namespace mediapipe {

// ===================================================================

void TfLiteConverterCalculatorOptions_TensorFloatRange::InitAsDefaultInstance() {
}
...
TfLiteConverterCalculatorOptions_TensorFloatRange::TfLiteConverterCalculatorOptions_TensorFloatRange()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.TfLiteConverterCalculatorOptions.TensorFloatRange)
}
...
const TfLiteConverterCalculatorOptions_TensorFloatRange& TfLiteConverterCalculatorOptions_TensorFloatRange::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_TfLiteConverterCalculatorOptions_TensorFloatRange_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto.base);
...
void TfLiteConverterCalculatorOptions::InitAsDefaultInstance() {
  ::mediapipe::_TfLiteConverterCalculatorOptions_default_instance_._instance.get_mutable()->output_tensor_float_range_ = const_cast< ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange*>(
      ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange::internal_default_instance());
}
...
TfLiteConverterCalculatorOptions::TfLiteConverterCalculatorOptions()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.TfLiteConverterCalculatorOptions)
}
...
void TfLiteConverterCalculatorOptions::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_TfLiteConverterCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto.base);
  ::memset(&output_tensor_float_range_, 0, static_cast<size_t>(
...
const TfLiteConverterCalculatorOptions& TfLiteConverterCalculatorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_TfLiteConverterCalculatorOptions_mediapipe_2fcalculators_2ftflite_2ftflite_5fconverter_5fcalculator_2eproto.base);
  return *internal_default_instance();
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          zero_center_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          max_num_channels_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 32)) {
          ...
          row_major_matrix_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          ...
          use_quantized_tensors_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          ...
          use_custom_normalization_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
void TfLiteConverterCalculatorOptions::InternalSwap(TfLiteConverterCalculatorOptions* other) {
  ...
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  swap(output_tensor_float_range_, other->output_tensor_float_range_);
  swap(use_custom_normalization_, other->use_custom_normalization_);
  swap(flip_vertically_, other->flip_vertically_);
  swap(row_major_matrix_, other->row_major_matrix_);
  swap(use_quantized_tensors_, other->use_quantized_tensors_);
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  TfLiteConverterCalculatorOptions::ext(kExtFieldNumber, *::mediapipe::TfLiteConverterCalculatorOptions::internal_default_instance());
...
template<> PROTOBUF_NOINLINE ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange* Arena::CreateMaybeMessage< ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange >(arena);
}
template<> PROTOBUF_NOINLINE ::mediapipe::TfLiteConverterCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::TfLiteConverterCalculatorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::TfLiteConverterCalculatorOptions >(arena);
}
