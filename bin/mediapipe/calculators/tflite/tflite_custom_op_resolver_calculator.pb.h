...
class TfLiteCustomOpResolverCalculatorOptions :
 ...
 public:
  ...
  virtual ~TfLiteCustomOpResolverCalculatorOptions();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto);
    return ::descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto.file_level_metadata[kIndexInFileMessages];
  }
