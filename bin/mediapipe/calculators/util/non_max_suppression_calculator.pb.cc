...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_NonMaxSuppressionCalculatorOptions_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto;
namespace mediapipe {
class NonMaxSuppressionCalculatorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<NonMaxSuppressionCalculatorOptions> _instance;
} _NonMaxSuppressionCalculatorOptions_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_NonMaxSuppressionCalculatorOptions_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_NonMaxSuppressionCalculatorOptions_default_instance_;
    new (ptr) ::mediapipe::NonMaxSuppressionCalculatorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::NonMaxSuppressionCalculatorOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_NonMaxSuppressionCalculatorOptions_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_NonMaxSuppressionCalculatorOptions_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 12, sizeof(::mediapipe::NonMaxSuppressionCalculatorOptions)},
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto_sccs[1] = {
  &scc_info_NonMaxSuppressionCalculatorOptions_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto = {
  &descriptor_table_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto_initialized, descriptor_table_protodef_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto, "mediapipe/calculators/util/non_max_suppression_calculator.proto", 746,
  &descriptor_table_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto_sccs, descriptor_table_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto_deps, 1, 1,
  ...
  file_level_metadata_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto, 1, file_level_enum_descriptors_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto), true);
namespace mediapipe {
...
void NonMaxSuppressionCalculatorOptions::InitAsDefaultInstance() {
}
...
NonMaxSuppressionCalculatorOptions::NonMaxSuppressionCalculatorOptions()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.NonMaxSuppressionCalculatorOptions)
}
...
void NonMaxSuppressionCalculatorOptions::SharedCtor() {
...
void NonMaxSuppressionCalculatorOptions::SharedDtor() {
}

void NonMaxSuppressionCalculatorOptions::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const NonMaxSuppressionCalculatorOptions& NonMaxSuppressionCalculatorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_NonMaxSuppressionCalculatorOptions_mediapipe_2fcalculators_2futil_2fnon_5fmax_5fsuppression_5fcalculator_2eproto.base);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          num_detection_streams_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          max_num_detections_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          ...
          return_empty_detections_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* NonMaxSuppressionCalculatorOptions::_InternalSerialize(
...
// @@protoc_insertion_point(message_byte_size_start:mediapipe.NonMaxSuppressionCalculatorOptions)
  ...
  if (cached_has_bits & 0x0000007fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(
          this->_internal_num_detection_streams());
    }
    ...
    if (cached_has_bits & 0x00000010u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(
          this->_internal_max_num_detections());
    }
...
void NonMaxSuppressionCalculatorOptions::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:mediapipe.NonMaxSuppressionCalculatorOptions)
  GOOGLE_DCHECK_NE(&from, this);
  const NonMaxSuppressionCalculatorOptions* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<NonMaxSuppressionCalculatorOptions>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mediapipe.NonMaxSuppressionCalculatorOptions)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mediapipe.NonMaxSuppressionCalculatorOptions)
    MergeFrom(*source);
  }
}
...
void NonMaxSuppressionCalculatorOptions::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:mediapipe.NonMaxSuppressionCalculatorOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void NonMaxSuppressionCalculatorOptions::InternalSwap(NonMaxSuppressionCalculatorOptions* other) {
  ...
  swap(return_empty_detections_, other->return_empty_detections_);
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  NonMaxSuppressionCalculatorOptions::ext(kExtFieldNumber, *::mediapipe::NonMaxSuppressionCalculatorOptions::internal_default_instance());
...
template<> PROTOBUF_NOINLINE ::mediapipe::NonMaxSuppressionCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::NonMaxSuppressionCalculatorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::NonMaxSuppressionCalculatorOptions >(arena);
}
