...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_AnnotationOverlayCalculatorOptions_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto;
...
namespace mediapipe {
class AnnotationOverlayCalculatorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<AnnotationOverlayCalculatorOptions> _instance;
} _AnnotationOverlayCalculatorOptions_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_AnnotationOverlayCalculatorOptions_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_AnnotationOverlayCalculatorOptions_default_instance_;
    new (ptr) ::mediapipe::AnnotationOverlayCalculatorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::AnnotationOverlayCalculatorOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_AnnotationOverlayCalculatorOptions_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_AnnotationOverlayCalculatorOptions_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto_sccs[1] = {
  &scc_info_AnnotationOverlayCalculatorOptions_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto = {
  &descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto_initialized, descriptor_table_protodef_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto, "mediapipe/calculators/util/annotation_overlay_calculator.proto", 482,
  &descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto_sccs, descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto_deps, 1, 2,
  ...
  file_level_metadata_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto, 1, file_level_enum_descriptors_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto), true);
namespace mediapipe {

// ===================================================================

void AnnotationOverlayCalculatorOptions::InitAsDefaultInstance() {
  ::mediapipe::_AnnotationOverlayCalculatorOptions_default_instance_._instance.get_mutable()->canvas_color_ = const_cast< ::mediapipe::Color*>(
...
AnnotationOverlayCalculatorOptions::AnnotationOverlayCalculatorOptions()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.AnnotationOverlayCalculatorOptions)
}
...
void AnnotationOverlayCalculatorOptions::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_AnnotationOverlayCalculatorOptions_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto.base);
  ::memset(&canvas_color_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&flip_text_vertically_) -
...
const AnnotationOverlayCalculatorOptions& AnnotationOverlayCalculatorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_AnnotationOverlayCalculatorOptions_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto.base);
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          canvas_width_px_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          canvas_height_px_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          ...
          flip_text_vertically_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          ...
          gpu_uses_top_left_origin_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
void AnnotationOverlayCalculatorOptions::InternalSwap(AnnotationOverlayCalculatorOptions* other) {
  ...
  swap(canvas_color_, other->canvas_color_);
  swap(flip_text_vertically_, other->flip_text_vertically_);
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  AnnotationOverlayCalculatorOptions::ext(kExtFieldNumber, *::mediapipe::AnnotationOverlayCalculatorOptions::internal_default_instance());
...
template<> PROTOBUF_NOINLINE ::mediapipe::AnnotationOverlayCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::AnnotationOverlayCalculatorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::AnnotationOverlayCalculatorOptions >(arena);
}
