...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_DetectionsToRectsCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto;
namespace mediapipe {
class DetectionsToRectsCalculatorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<DetectionsToRectsCalculatorOptions> _instance;
} _DetectionsToRectsCalculatorOptions_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_DetectionsToRectsCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mediapipe::_DetectionsToRectsCalculatorOptions_default_instance_;
    new (ptr) ::mediapipe::DetectionsToRectsCalculatorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::DetectionsToRectsCalculatorOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_DetectionsToRectsCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_DetectionsToRectsCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto}, {}};
...
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto = nullptr;
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, sizeof(::mediapipe::DetectionsToRectsCalculatorOptions)},
};
...
const char descriptor_table_protodef_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "diapipe/framework/calculator.proto\"\336\002\n\"D"
  ...
  "tections\030\005 \001(\0102[\n\003ext\022\034.mediapipe.Calcul"
  "atorOptions\030\337\267\241} \001(\0132-.mediapipe.Detecti"
  "onsToRectsCalculatorOptions"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto_sccs[1] = {
  &scc_info_DetectionsToRectsCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto = {
  &descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto_initialized, descriptor_table_protodef_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto, "mediapipe/calculators/util/detections_to_rects_calculator.proto", 467,
  &descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto_sccs, descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto_deps, 1, 1,
  ...
  file_level_metadata_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto, 1, file_level_enum_descriptors_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto), true);
namespace mediapipe {

// ===================================================================

void DetectionsToRectsCalculatorOptions::InitAsDefaultInstance() {
}
...
DetectionsToRectsCalculatorOptions::DetectionsToRectsCalculatorOptions()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.DetectionsToRectsCalculatorOptions)
}
DetectionsToRectsCalculatorOptions::DetectionsToRectsCalculatorOptions(const DetectionsToRectsCalculatorOptions& from)
  ...
  ::memcpy(&rotation_vector_start_keypoint_index_, &from.rotation_vector_start_keypoint_index_,
    static_cast<size_t>(reinterpret_cast<char*>(&output_zero_rect_for_empty_detections_) -
    reinterpret_cast<char*>(&rotation_vector_start_keypoint_index_)) + sizeof(output_zero_rect_for_empty_detections_));
...
void DetectionsToRectsCalculatorOptions::SharedCtor() {
  ::memset(&rotation_vector_start_keypoint_index_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&output_zero_rect_for_empty_detections_) -
      reinterpret_cast<char*>(&rotation_vector_start_keypoint_index_)) + sizeof(output_zero_rect_for_empty_detections_));
}
...
const DetectionsToRectsCalculatorOptions& DetectionsToRectsCalculatorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_DetectionsToRectsCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frects_5fcalculator_2eproto.base);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          rotation_vector_start_keypoint_index_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          rotation_vector_end_keypoint_index_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          ...
          output_zero_rect_for_empty_detections_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void DetectionsToRectsCalculatorOptions::InternalSwap(DetectionsToRectsCalculatorOptions* other) {
  ...
  swap(rotation_vector_start_keypoint_index_, other->rotation_vector_start_keypoint_index_);
  swap(rotation_vector_end_keypoint_index_, other->rotation_vector_end_keypoint_index_);
  swap(rotation_vector_target_angle_, other->rotation_vector_target_angle_);
  swap(rotation_vector_target_angle_degrees_, other->rotation_vector_target_angle_degrees_);
  swap(output_zero_rect_for_empty_detections_, other->output_zero_rect_for_empty_detections_);
}
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  DetectionsToRectsCalculatorOptions::ext(kExtFieldNumber, *::mediapipe::DetectionsToRectsCalculatorOptions::internal_default_instance());
...
template<> PROTOBUF_NOINLINE ::mediapipe::DetectionsToRectsCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::DetectionsToRectsCalculatorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::DetectionsToRectsCalculatorOptions >(arena);
}
