...
class RectTransformationCalculatorOptions :
 ...
 public:
  ...
  virtual ~RectTransformationCalculatorOptions();
  ...
  inline RectTransformationCalculatorOptions* New() const final {
    return CreateMaybeMessage<RectTransformationCalculatorOptions>(nullptr);
  }

  RectTransformationCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_mediapipe_2fcalculators_2futil_2frect_5ftransformation_5fcalculator_2eproto);
    return ::descriptor_table_mediapipe_2fcalculators_2futil_2frect_5ftransformation_5fcalculator_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 rotation_degrees() const;
  void set_rotation_degrees(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_rotation_degrees() const;
  void _internal_set_rotation_degrees(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  float rotation_;
  ::PROTOBUF_NAMESPACE_ID::int32 rotation_degrees_;
  float shift_x_;
  float shift_y_;
  bool square_long_;
  bool square_short_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RectTransformationCalculatorOptions::_internal_rotation_degrees() const {
  return rotation_degrees_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RectTransformationCalculatorOptions::rotation_degrees() const {
...
inline void RectTransformationCalculatorOptions::_internal_set_rotation_degrees(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  rotation_degrees_ = value;
}
inline void RectTransformationCalculatorOptions::set_rotation_degrees(::PROTOBUF_NAMESPACE_ID::int32 value) {
