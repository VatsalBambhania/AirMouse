...
extern PROTOBUF_INTERNAL_EXPORT_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_DetectionsToRenderDataCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto;
...
class DetectionsToRenderDataCalculatorOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<DetectionsToRenderDataCalculatorOptions> _instance;
} _DetectionsToRenderDataCalculatorOptions_default_instance_;
}  // namespace mediapipe
static void InitDefaultsscc_info_DetectionsToRenderDataCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  ::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_.DefaultConstruct();
  *::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_.get_mutable() = std::string(",", 1);
  ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyString(
      ::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_.get_mutable());
  ::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_.DefaultConstruct();
  *::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_.get_mutable() = std::string("DETECTION", 9);
  ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyString(
      ::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_.get_mutable());
  {
    void* ptr = &::mediapipe::_DetectionsToRenderDataCalculatorOptions_default_instance_;
    new (ptr) ::mediapipe::DetectionsToRenderDataCalculatorOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mediapipe::DetectionsToRenderDataCalculatorOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_DetectionsToRenderDataCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_DetectionsToRenderDataCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto_sccs[1] = {
  &scc_info_DetectionsToRenderDataCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto.base,
};
...
static bool descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto = {
  &descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto_initialized, descriptor_table_protodef_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto, "mediapipe/calculators/util/detections_to_render_data_calculator.proto", 593,
  &descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto_sccs, descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto_deps, 1, 3,
  ...
  file_level_metadata_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto, 1, file_level_enum_descriptors_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto), true);
namespace mediapipe {

// ===================================================================

void DetectionsToRenderDataCalculatorOptions::InitAsDefaultInstance() {
  ::mediapipe::_DetectionsToRenderDataCalculatorOptions_default_instance_._instance.get_mutable()->text_ = const_cast< ::mediapipe::RenderAnnotation_Text*>(
      ::mediapipe::RenderAnnotation_Text::internal_default_instance());
  ::mediapipe::_DetectionsToRenderDataCalculatorOptions_default_instance_._instance.get_mutable()->color_ = const_cast< ::mediapipe::Color*>(
...
::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_;
...
::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_;
DetectionsToRenderDataCalculatorOptions::DetectionsToRenderDataCalculatorOptions()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:mediapipe.DetectionsToRenderDataCalculatorOptions)
}
DetectionsToRenderDataCalculatorOptions::DetectionsToRenderDataCalculatorOptions(const DetectionsToRenderDataCalculatorOptions& from)
  ...
  text_delimiter_.UnsafeSetDefault(&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_.get());
  if (from._internal_has_text_delimiter()) {
    text_delimiter_.AssignWithDefault(&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_.get(), from.text_delimiter_);
  }
  scene_class_.UnsafeSetDefault(&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_.get());
  if (from._internal_has_scene_class()) {
    scene_class_.AssignWithDefault(&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_.get(), from.scene_class_);
  }
...
void DetectionsToRenderDataCalculatorOptions::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_DetectionsToRenderDataCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto.base);
  text_delimiter_.UnsafeSetDefault(&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_.get());
  scene_class_.UnsafeSetDefault(&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_.get());
...
void DetectionsToRenderDataCalculatorOptions::SharedDtor() {
  text_delimiter_.DestroyNoArena(&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_.get());
  scene_class_.DestroyNoArena(&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_.get());
...
const DetectionsToRenderDataCalculatorOptions& DetectionsToRenderDataCalculatorOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_DetectionsToRenderDataCalculatorOptions_mediapipe_2fcalculators_2futil_2fdetections_5fto_5frender_5fdata_5fcalculator_2eproto.base);
...
// @@protoc_insertion_point(message_clear_start:mediapipe.DetectionsToRenderDataCalculatorOptions)
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      text_delimiter_.UnsafeMutablePointer()->assign(*&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_.get());
    }
    if (cached_has_bits & 0x00000002u) {
      scene_class_.UnsafeMutablePointer()->assign(*&::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_.get());
    }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          produce_empty_packet_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          one_label_per_line_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 64)) {
          ...
          render_detection_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void DetectionsToRenderDataCalculatorOptions::InternalSwap(DetectionsToRenderDataCalculatorOptions* other) {
  ...
  text_delimiter_.Swap(&other->text_delimiter_, &::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_.get(),
    GetArenaNoVirtual());
  scene_class_.Swap(&other->scene_class_, &::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_.get(),
    GetArenaNoVirtual());
  swap(text_, other->text_);
  swap(color_, other->color_);
  swap(one_label_per_line_, other->one_label_per_line_);
  swap(render_detection_id_, other->render_detection_id_);
...
::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  DetectionsToRenderDataCalculatorOptions::ext(kExtFieldNumber, *::mediapipe::DetectionsToRenderDataCalculatorOptions::internal_default_instance());
...
template<> PROTOBUF_NOINLINE ::mediapipe::DetectionsToRenderDataCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::DetectionsToRenderDataCalculatorOptions >(Arena* arena) {
  return Arena::CreateInternal< ::mediapipe::DetectionsToRenderDataCalculatorOptions >(arena);
}
