...
inline bool LabelsToRenderDataCalculatorOptions_Location_Parse(
    const std::string& name, LabelsToRenderDataCalculatorOptions_Location* value) {
...
class LabelsToRenderDataCalculatorOptions :
 ...
 public:
  ...
  virtual ~LabelsToRenderDataCalculatorOptions();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_mediapipe_2fcalculators_2futil_2flabels_5fto_5frender_5fdata_5fcalculator_2eproto.file_level_metadata[kIndexInFileMessages];
  }
