...
class AnnotationOverlayCalculatorOptions :
 ...
 public:
  ...
  virtual ~AnnotationOverlayCalculatorOptions();
  ...
  inline AnnotationOverlayCalculatorOptions* New() const final {
    return CreateMaybeMessage<AnnotationOverlayCalculatorOptions>(nullptr);
  }

  AnnotationOverlayCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto);
    return ::descriptor_table_mediapipe_2fcalculators_2futil_2fannotation_5foverlay_5fcalculator_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::mediapipe::Color* release_canvas_color();
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 canvas_width_px() const;
  void set_canvas_width_px(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_canvas_width_px() const;
  void _internal_set_canvas_width_px(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 canvas_height_px() const;
  void set_canvas_height_px(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_canvas_height_px() const;
  void _internal_set_canvas_height_px(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 canvas_width_px_;
  ::PROTOBUF_NAMESPACE_ID::int32 canvas_height_px_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 AnnotationOverlayCalculatorOptions::_internal_canvas_width_px() const {
  return canvas_width_px_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AnnotationOverlayCalculatorOptions::canvas_width_px() const {
...
inline void AnnotationOverlayCalculatorOptions::_internal_set_canvas_width_px(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
  canvas_width_px_ = value;
}
inline void AnnotationOverlayCalculatorOptions::set_canvas_width_px(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 AnnotationOverlayCalculatorOptions::_internal_canvas_height_px() const {
  return canvas_height_px_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AnnotationOverlayCalculatorOptions::canvas_height_px() const {
...
inline void AnnotationOverlayCalculatorOptions::_internal_set_canvas_height_px(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000008u;
  canvas_height_px_ = value;
}
inline void AnnotationOverlayCalculatorOptions::set_canvas_height_px(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::mediapipe::Color* AnnotationOverlayCalculatorOptions::mutable_canvas_color() {
  ...
  return _internal_mutable_canvas_color();
}
