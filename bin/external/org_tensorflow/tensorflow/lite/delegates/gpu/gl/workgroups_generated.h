...
inline HardcodedWorkgroupT *HardcodedWorkgroup::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tflite::gpu::gl::data::HardcodedWorkgroupT> _o = std::unique_ptr<tflite::gpu::gl::data::HardcodedWorkgroupT>(new HardcodedWorkgroupT());
...
inline HardcodedWorkgroupsT *HardcodedWorkgroups::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tflite::gpu::gl::data::HardcodedWorkgroupsT> _o = std::unique_ptr<tflite::gpu::gl::data::HardcodedWorkgroupsT>(new HardcodedWorkgroupsT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline CustomWorkgroupsT *CustomWorkgroups::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tflite::gpu::gl::data::CustomWorkgroupsT> _o = std::unique_ptr<tflite::gpu::gl::data::CustomWorkgroupsT>(new CustomWorkgroupsT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
