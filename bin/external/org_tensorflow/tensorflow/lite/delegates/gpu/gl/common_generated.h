...
inline Uint3T *Uint3::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tflite::gpu::gl::data::Uint3T> _o = std::unique_ptr<tflite::gpu::gl::data::Uint3T>(new Uint3T());
...
inline Uint2T *Uint2::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tflite::gpu::gl::data::Uint2T> _o = std::unique_ptr<tflite::gpu::gl::data::Uint2T>(new Uint2T());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline Uint1T *Uint1::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tflite::gpu::gl::data::Uint1T> _o = std::unique_ptr<tflite::gpu::gl::data::Uint1T>(new Uint1T());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
